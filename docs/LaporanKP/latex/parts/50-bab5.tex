...
\begin{enumerate}[leftmargin=2cm]
  ...
  \item \textit{Scoring engine} yang terdiri atas 5 fungsi murni berhasil diimplementasikan dan diverifikasi melalui 59 kasus uji yang mencakup skenario penjumlahan sumatif, pembalikan skor, pengelompokan dimensional, dan validasi kelengkapan jawaban. Seluruh komputasi skor bersifat deterministik dan bebas efek samping.
  ...
  \item Pengujian komprehensif dengan total 191 kasus uji dalam 21 \textit{file} uji dan \textit{pipeline} CI/CD dua \textit{job} paralel berhasil menjaga kualitas kode sepanjang siklus pengembangan.
