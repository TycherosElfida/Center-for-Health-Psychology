...
\begin{enumerate}[leftmargin=2cm]
  ...
  \item Pengujian komprehensif dengan total 213 kasus uji dalam 25 \textit{file} uji dan \textit{pipeline} CI/CD dua \textit{job} paralel berhasil menjaga kualitas kode sepanjang siklus pengembangan.
