...
\begin{enumerate}[leftmargin=2cm]
  ...
  \item \textit{Scoring engine} (\texttt{computeScore}, \texttt{reverseScore}, \texttt{\seqsplit{lookupInterpretation}}, \texttt{\seqsplit{validateAnswerValues}}, \texttt{\seqsplit{validateCompleteness}}) yang mengandung logika komputasi skor deterministik.
