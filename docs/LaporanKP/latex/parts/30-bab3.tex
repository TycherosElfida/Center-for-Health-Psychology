...
Kedua klaster dihubungkan oleh 4 \textit{foreign key} lintas-klaster: \texttt{test\_sessions.test\_id}, \texttt{test\_sessions.user\_id}, \texttt{results.test\_id}, dan \texttt{report\_requests.session\_id}.

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.85\textwidth]{figures/gambar_3_3b_er_pengguna_admin.png}
