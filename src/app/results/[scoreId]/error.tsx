...
/**
 * Results Page Error Boundary — scoped to /results/[scoreId].
 *
 * Shows a context-specific message when results fail to load,
 * with retry and catalog navigation options.
 */
...
export default function ResultsError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error("[CHP] Results page error:", error);
  }, [error]);
