...
\textit{Simplified Resilience Scale} (SRS) dikembangkan oleh Manning, Carr, dan Kail (2016) sebagai ukuran ringkas resiliensi yang disusun dari butir Satisfaction With Life Scale (Diener dkk., 1985) dan Pearlin Mastery Scale (Pearlin \& Schooler, 1978), mengacu pada kerangka Resilience Scale (Wagnild \& Young, 1993). Versi asli terdiri dari dua belas butir dan bersifat unidimensional. Platform menggunakan adaptasi sebelas butir berskala Likert enam poin (1--6); lima butir (1, 3, 5, 7, 11) diberi skor terbalik. Pengelompokan ke dalam tiga aspek (efikasi, kepuasan, kontrol) bersifat deskriptif mengikuti instrumen sumber dan bukan struktur yang tervalidasi. Adaptasi ini belum melalui validasi psikometrik formal di Indonesia dan digunakan secara indikatif. Pemosisian rentang interpretasi (\textit{bands}/kategori) Rendah, Sedang, dan Tinggi pada platform ini merupakan ketetapan heuristik berdasarkan distribusi skor secara proporsional dari rentang minimum (11) dan maksimum (66), mengingat adaptasi ini belum memiliki ambang batas (\textit{cutoff}) normatif yang terstandardisasi.
...
\textit{Self-Reporting Questionnaire} (SRQ-29) dikembangkan oleh World Health Organization (Beusenberg \& Orley, 1994) dan terdiri dari dua puluh sembilan butir dengan respons biner (Ya/Tidak). Penilaian bersifat berbasis klaster: domain Gejala Mental Emosional atau GME (butir 1--20) ditandai bila terdapat enam atau lebih jawaban ``Ya'', sedangkan domain penggunaan zat (butir 21), psikotik (butir 22--24), dan stres pascatrauma (butir 25--29) ditandai bila terdapat minimal satu jawaban ``Ya''. Instrumen ini bersifat skrining, bukan diagnostik; hasil positif memerlukan evaluasi klinis lanjutan. Versi 20-butir dari instrumen ini (SRQ-20) telah divalidasi dan digunakan secara nasional di Indonesia (Riskesdas; Idaiani dkk., 2019), sementara platform ini secara operasional menggunakan versi penuh 29-butir untuk asesmen komprehensif.

\noindent\textbf{Skala respons:} 0 = Tidak, 1 = Ya.

{\footnotesize
\renewcommand{\arraystretch}{1.3}
\begin{longtable}{|p{0.7cm}|p{8.9cm}|p{3.0cm}|}
\hline
...
\hline
\endfoot
1 & Apakah kamu sering merasa sakit kepala? & GME \\
\hline
2 & Apakah kamu kehilangan nafsu makan? & GME \\
\hline
3 & Apakah tidur kamu tidak nyenyak? & GME \\
\hline
4 & Apakah kamu mudah merasa takut? & GME \\
\hline
5 & Apakah kamu merasa cemas, tegang, atau khawatir? & GME \\
\hline
6 & Apakah tangan kamu gemetar? & GME \\
\hline
7 & Apakah kamu mengalami gangguan pencernaan? & GME \\
\hline
8 & Apakah kamu merasa sulit berpikir jernih? & GME \\
\hline
9 & Apakah kamu merasa tidak bahagia? & GME \\
\hline
10 & Apakah kamu lebih sering menangis? & GME \\
\hline
11 & Apakah kamu merasa sulit untuk menikmati aktivitas sehari-hari? & GME \\
\hline
12 & Apakah kamu mengalami kesulitan untuk mengambil keputusan? & GME \\
\hline
13 & Apakah aktivitas/tugas sehari-hari kamu terbengkalai? & GME \\
\hline
14 & Apakah kamu merasa tidak mampu berperan dalam kehidupan ini? & GME \\
\hline
15 & Apakah kamu kehilangan minat terhadap banyak hal? & GME \\
\hline
16 & Apakah kamu merasa tidak berharga? & GME \\
\hline
17 & Apakah kamu mempunyai pikiran untuk mengakhiri hidup kamu? & GME \\
\hline
18 & Apakah kamu merasa lelah sepanjang waktu? & GME \\
\hline
19 & Apakah kamu merasa tidak enak di perut? & GME \\
\hline
20 & Apakah kamu mudah lelah? & GME \\
\hline
