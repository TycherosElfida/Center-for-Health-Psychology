...
\begin{enumerate}[leftmargin=2cm]
  ...
  \item \textbf{Penyamaran IP dan enkripsi surel}: alamat IP di-\textit{hash} satu arah; surel dienkripsi AES-256-GCM dalam tabel \texttt{guest\_leads} yang terisolasi (secara operasional, tabel ini merupakan infrastruktur skema untuk fitur pengumpulan prospek di masa mendatang dan saat ini belum menampung data aktif).
\end{enumerate}
