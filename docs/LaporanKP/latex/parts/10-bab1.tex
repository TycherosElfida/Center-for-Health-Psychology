...
\begin{xltabular}{\textwidth}{@{}c >{\raggedright\arraybackslash}p{3.5cm} >{\raggedright\arraybackslash}p{3.8cm} >{\raggedright\arraybackslash}p{3.5cm}@{}}
  ...
  2 & Meng\-implementasikan \textit{scoring engine} modular otomatis untuk perhitungan sumatif, berbobot, dimensional, dan persentil & Skor komputasi sesuai nilai referensi manual; \textit{engine} diuji dengan 72 kasus uji & Selesai: Fase 1B (Minggu 3--6) \\[0.5em]
